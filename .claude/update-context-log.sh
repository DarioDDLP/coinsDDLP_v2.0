#!/bin/bash
# Hook PostToolUse: registra en CLAUDE.md los ficheros modificados durante la sesión

CONTEXT_FILE="/Users/dariodelapoza/Documents/Proyectos/coinsDDLP_v2.0/CLAUDE.md"
...
# Solo registrar ficheros dentro del proyecto coinsDDLP_v2.0 (excluir el propio CLAUDE.md y logs)
if [[ "$FILE_PATH" == *"coinsDDLP_v2.0"* ]] && \
  ...
  # Actualizar la línea "Última actualización" en CLAUDE.md
  TODAY=$(date '+%Y-%m-%d')

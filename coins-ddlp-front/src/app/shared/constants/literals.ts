export const LITERALS = {
  ...
  pesetas: {
    denominationsTitle: 'Colección Pesetas',
    searchDenominations: 'Buscar por denominación...',
    allLabel: 'Todas',
    allTitle: 'Todas las pesetas',
    allSearch: 'Buscar por valor, título o año...',
    title: 'Pesetas',
    search: 'Buscar por título o año...',
    back: 'Volver',
    colYear: 'Año',
    colTitle: 'Título',
    colConservation: 'Estado',
  ...
  pesetaDetail: {
    ...
    labelRuler: 'Gobernante',
    labelMint: 'Ceca',
    labelDemonetized: 'Desmonetización',
    labelKmRef: 'Ref. KM',
    labelEngraverObverse: 'Grabador anverso',
    labelEngraverReverse: 'Grabador reverso',
    labelMintYear: 'Año acuñación',
    labelMintage: 'Tirada',
    labelObverse: 'Anverso',
    labelReverse: 'Reverso',
